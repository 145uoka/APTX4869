...
import com.olympus.aptx4869.dbflute.cbean.cq.bs.BsGenreCQ;
 ...
 */
public class GenreCQ extends BsGenreCQ {
     ...
     */
    public GenreCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
