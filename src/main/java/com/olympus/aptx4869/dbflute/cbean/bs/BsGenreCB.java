...
public class BsGenreCB extends AbstractConditionBean {
    ...
    //                                                                           Attribute
    //                                                                           =========
    protected GenreCQ _conditionQuery;
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_GenreId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_GenreId_Desc();
        return this;
    }
     ...
     */
    public GenreCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public GenreCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected GenreCQ doGetConditionQuery() {
    ...
    protected GenreCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected GenreCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        GenreCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected GenreCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new GenreCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<GenreCB> unionCBLambda) {
        final GenreCB cb = new GenreCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final GenreCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<GenreCB> unionCBLambda) {
        final GenreCB cb = new GenreCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final GenreCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<GenreCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<GenreCQ> qyCall
         ...
         */
        public HpSDRFunction<GenreCB, GenreCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<GenreCB> sq, GenreCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public GenreCB dreamCruiseCB() {
        GenreCB cb = new GenreCB();
        cb.xsetupForDreamCruise((GenreCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<GenreCB> columnQuery(final SpecifyQuery<GenreCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected GenreCB xcreateColumnQueryCB() {
        GenreCB cb = new GenreCB();
        cb.xsetupForColumnQuery((GenreCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<GenreCB> orCBLambda) {
        xorSQ((GenreCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<GenreCB> andCBLambda) {
        xorSQAP((GenreCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return GenreCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return GenreCQ.class.getName(); }
